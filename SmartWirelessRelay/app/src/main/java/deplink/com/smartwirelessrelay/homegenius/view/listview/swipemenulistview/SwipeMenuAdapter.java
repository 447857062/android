...
public class SwipeMenuAdapter implements WrapperListAdapter,
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
          ...
          //  layout.closeMenu();
            //获取当前打开的menu的position，数据刷新的时候这个menu不让消失
           int  currentMenuShowPosition= Perfence.getIntPerfence("currentMenuOpenedPosition");
            if(currentMenuShowPosition==position){
