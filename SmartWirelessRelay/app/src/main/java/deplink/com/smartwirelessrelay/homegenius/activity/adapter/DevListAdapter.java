...
public class DevListAdapter extends BaseAdapter{
    ...
    public DevListAdapter(Context mContext,List<Device>mDevices) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        String deviceName=mDatas.get(position).getUid();
        if(deviceName.equals("")){
            deviceName="未知";
        }
        vh.device_uid.setText("uid:"+deviceName);
        vh.device_statu.setText("状态："+mDatas.get(position).getStatus());
