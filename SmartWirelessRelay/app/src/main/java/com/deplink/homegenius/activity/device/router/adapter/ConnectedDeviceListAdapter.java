package com.deplink.homegenius.activity.device.router.adapter;
...
public class ConnectedDeviceListAdapter extends BaseSwipListAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView==null){
            ...
            vh.tx= convertView.findViewById(R.id.textview_uploadspeed);
            vh.rx= convertView.findViewById(R.id.textview_downloadspeed);
