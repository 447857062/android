package com.deplink.homegenius.activity.personal.softupdate.download;
...
public class UpdateService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (!startDownload && intent != null) {
            ...
            Log.i(TAG, "icoResId: " + icoResId);
            Log.i(TAG, "icoSmallResId: " + icoSmallResId);
            Log.i(TAG, "storeDir: " + storeDir);
            Log.i(TAG, "updateProgress: " + updateProgress);
            Log.i(TAG, "downloadNotificationFlag: " + downloadNotificationFlag);
            Log.i(TAG, "downloadErrorNotificationFlag: " + downloadErrorNotificationFlag);
            Log.i(TAG, "downloadSuccessNotificationFlag: " + downloadSuccessNotificationFlag);
            Log.i(TAG, "isSendBroadcast: " + isSendBroadcast);
    ...
    private static class DownloadApk extends AsyncTask<String, Integer, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            Log.i(TAG, "download apk cache at " + file.getAbsolutePath());
    ...
    public static class Builder {
        ...
        public static Builder create(String downloadUrl) {
            ...
            Log.i(TAG, "create download service");
