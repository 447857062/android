 ...
 */
public class ConfigGetwayDialog extends Dialog implements View.OnClickListener {
    private Context mContext;
    public ConfigGetwayDialog(Context context) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View view = LayoutInflater.from(mContext).inflate(R.layout.config_getway_dialog, null);
    ...
    public void setCancelBtnClickListener(onCancelBtnClickListener cancelBtnClickListener) {

        this.monCancelBtnClickListener = cancelBtnClickListener;
    }
