 ...
 * The Intents have an SDKAction of
...
public class MqttService extends Service implements MqttTraceHandler {
    ...
    private Map<String/* clientHandle */, MqttServiceClient/* client */> clients = new HashMap<>();
    ...
    /**
     * get an MqttServiceClient object to represent a connect to a server
     *
     * @param serverURI
     * @param clientId
    ...
    public String getClient(String serverURI, String clientId, MqttClientPersistence persistence) {
        ...
        if (!clients.containsKey(clientHandle)) {
            Log.d(DeplinkSDK.SDK_TAG, "====>create MqttServiceClient");
            MqttServiceClient client = new MqttServiceClient(this, serverURI, clientId, persistence, clientHandle);
     ...
     *
     * @param clientHandle      identifies the MqttServiceClient to use
     * @param connectOptions    the MQTT connect options to be used
     ...
     * @throws MqttException
     */
    public IMqttDeliveryToken publish(String clientHandle, String topic, byte[] payload, int qos, boolean retained, String invocationContext, String activityToken)
            throws MqttException {
        MqttServiceClient client = clientFromHandle(clientHandle);
    ...
    private MqttServiceClient clientFromHandle(String clientHandle) {
        ...
        if (client == null) {
            Log.d(DeplinkSDK.SDK_TAG, "===>clientFromHandle get null");
    ...
    public IBinder onBind(Intent intent) {
        ...
        //activityToken="44d83a903472ff978b82906530f64277";
    ...
    public void traceException(String tag, String message, Exception e) {
        if (traceCallbackId != null) {
            ...
            dataBundle.putString(MqttServiceConstants.CALLBACK_ACTION, MqttServiceConstants.TRACE_ACTION);
            dataBundle.putString(MqttServiceConstants.CALLBACK_ERROR_MESSAGE, message);
            dataBundle.putString(MqttServiceConstants.CALLBACK_EXCEPTION_STACK, Log.getStackTraceString(e));
            callbackToActivity(null, Status.ERROR, dataBundle);
        }
    }
